...
public class LoginConsumer extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (cursor != null) {
                    if (cursor.getCount() > 0) {
                        ...
                        Toast.makeText(LoginConsumer.this, "Logged In succesfully!",
                                Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(LoginConsumer.this, ConsumerActivity.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(LoginConsumer.this, "Invalid username or password!",
